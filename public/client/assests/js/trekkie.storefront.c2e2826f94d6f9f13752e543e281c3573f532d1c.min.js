    ...
    var e = {
            ...
            8142: function(e, t, n) {
                ...
                var a = n(7385),
                    ...
                    s = function(e) {
                        ...
                        return o(t, e), t.prototype.identify = function(e) {}, t.prototype.track = function(e) {}, t.prototype.page = function(e) {
                        ...
                        }, t.prototype.viewedProductCategory = function(e) { this.emitEvent("ViewCategory", e.eventId, a.ANALYTICS_VIEWED_PRODUCT_CATEGORY) }, t.prototype.addedProduct = function(e) {
                            var t = e.properties,
                            ...
                            this.emitEvent("Search", e.eventId, a.ANALYTICS_PERFORMED_SEARCH, t)
                        }, t.prototype.emitEvent = function(e, t, n, r) { window.pintrk("track", e, i({ np: "shopify" }, r)), this.addMonorailBatchEvent(c.objectAssignFilterUndefined({ eventName: n }, { eventId: t, eventProperties: r ? JSON.stringify(r) : void 0 })) }, t.prototype.getOrderNumItems = function(e) {
                            for (var t = 0, n = 0, r = e.products || []; n < r.length; n++) {
                                var o = r[n];
                                this.getProductKey(o) && (t += o.quantity || 1)
                            }
            ...
            6971: function(e, t, n) {
                ...
                var a = n(7385),
                    ...
                    u = function(e) {
                        function t(n, r, o) { var i = e.call(this, t.defaultOptions, n, r.defaultAttributes) || this; return e.prototype.ensureTrackingConsent.call(i, (function() { i.initialize(o) }), o), i }
                        return o(t, e), t.prototype.isEssential = function() { return !1 }, t.prototype.identify = function(e) { throw new Error("identify is not supported") }, t.prototype.page = function(e) { this.emitEvent("PAGE_VIEW", null == e ? void 0 : e.eventId, a.ANALYTICS_PAGE_VIEW, { integration: "shopify-native" }) }, t.prototype.track = function(e) { var t = {}; for (var n in e.properties) "revenue" === n ? t.price = this.formatRevenue(e.properties.revenue) : t[n] = e.properties[n] }, t.prototype.viewedProductCategory = function(e) {}, t.prototype.viewedProductVariant = function(e) {}, t.prototype.viewedProduct = function(e) {
                            var t = e.properties,
                            ...
                            var t = e.properties,
                                n = s.objectAssignFilterUndefined({ item_ids: this.getOrderContentIds(t), item_type: this.getOrderContentType(t), currency: this.getCurrency(t.currency), description: t.orderName || "", price: this.formatRevenue(t.revenue), number_items: this.getOrderNumItems(t), integration: "shopify-native" }, { transaction_id: t.orderId });
            ...
            997: function(e, t) {
                ...
                function i(e, t) { if (a()) { var n = new window.Blob([t], { type: "text/plain" }); if (window.navigator.sendBeacon(e, n)) return !0 } var r = new XMLHttpRequest; try { r.open("POST", e, !0), r.setRequestHeader("Content-Type", "text/plain"), r.send(t) } catch (e) { console.log(e) } return !1 }
            ...
            2308: function(e, t, n) {
                ...
                }, t.setGlobalSerializedAppConfig = function(e) { r = e }, t.internalError = function(e, n, a) {
                    var c = { name: n.name, line: n.lineNumber || n.line, script: n.fileName || n.sourceURL || n.script, stack: n.stackTrace || n.stack || n.description, message: n.message, url: o.href(), context: void 0 !== a ? a : null, appConfig: r || null };
                    i.emitError("internalError_" + e, t.requestImpl.queryString(c))
                }
            },
            5522: function(e, t, n) {
            ...
            5316: function(e, t, n) {
                ...
                } catch (e) { o.internalError("index_storefront", e) }
            },
            9426: function(e, t, n) {
                ...
                var r = n(8831),
                    ...
                    m = function() {
                        ...
                        return e.prototype.logAssetContext = function(e) {
                            ...
                            for (var i = this.waitFor(e.length, (function() { try { r(), c.flushBatchEvents() } catch (e) { o.internalError("readyCallback", e) } })), a = 0, s = e; a < s.length; a++) {
                                var u = s[a];
                                try {
                                    var p = t[u[0]];
                                ...
                                } catch (e) { i(), o.internalError("loadIntegration", e) }
                            }
                        }, e.prototype.identify = function(e, t, n) {
                            void 0 === e && (e = ""), void 0 === t && (t = {});
                            var r = this.getS2SEventId(void 0, n);
                            e instanceof Object && (t = e, e = "");
                            for (var i = 0, a = this.integrations; i < a.length; i++) { var c = a[i]; try { c.identify({ id: e, properties: t, eventId: r.eventId, s2sMetadata: r.s2sMetadata }) } catch (e) { o.internalError("identify", e) } }
                            ...
                            for (var i = this.generatePageObject(e, t, r.eventId, r.s2sMetadata), a = function(e) {
                                    ...
                                    } catch (e) { o.internalError("page", e) }
                            ...
                            for (var i = { event: e, properties: t, eventId: r.eventId, s2sMetadata: r.s2sMetadata }, a = function(e) {
                                    ...
                                    } catch (e) { o.internalError("track", e) }
                                }, c = this, u = 0, p = this.integrations; u < p.length; u++) a(p[u]);
                            return r.eventId
                        }, e.prototype.ready = function(e) { try { e() } catch (e) { o.internalError("ready", e) } }, e.prototype.waitFor = function(e, t) { return 0 === e ? (setTimeout(t, 0), function() {}) : function() { 0 == --e && setTimeout(t, 0) } }, e.prototype.generatePageObject = function(e, t, n, r) {
                            var o = a.href(),
                                c = o.indexOf("?");
