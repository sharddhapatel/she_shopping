                                                        ...
                                                        <div class="grid-view-item__image-wrapper js position-center">
                                                            <a href="">
                                                                <div class="image-inner">
                                                                    <div class="reveal">
                                                                        <img class="grid-view-item__image lazy owl-lazy main-img loaded" data-src="{{url('item_img')}}/{{$detail->tblproductimage}}" alt="" src="{{url('item_img')}}/{{$detail->tblproductimage}}" data-was-processed="true" style="opacity: 1; width: 250px; height: 300px;">
                                                            ...
                                                            <div class="thumbnail-buttons button-position-center">
                                                                <div class="quick-view card-1" style="background: none; margin: 8px 2px;">
                                                                    <a href="{{url('addtocart')}}/{{$detail->id}}">
                                                                        ADD TO CART
                                                                    </a>
                                                                </div>
